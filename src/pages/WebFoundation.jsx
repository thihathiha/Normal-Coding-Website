...
const skillSections = [
  {
    ...
    items: ["How websites work", "Browser & server basics", "Developer tools"],
    image: checkblue,
    bg: "bg-[#3B82F6]"
  },
  {
    ...
    <>
      <section className="p-4">
        ...
        <div className="flex items-center p-4">
          <img src={cap} alt="cap" className="w-15" />
          <div>
            <h2 className="bg-white px-3 lg:text-2xl text-xl font-bold text-gray-900 mb-2">
              Web Foundation Program
            </h2>
            <button className="text-xs px-2 py-2 bg-[#3B82F6] rounded-full">6 weeks</button>
        ...
        <div className="flex items-center p-4">
         ...
         <div className="flex flex-col justify-around items-center bg-[#0F172A] mt-8 p-4 rounded-xl w-full shadow-lg">
          ...
          <button className="bg-[#3B82F6] p-2 rounded-md mt-4"><a href="#">Enroll Now</a></button>
         </div>
      </section>
    </>
  );
